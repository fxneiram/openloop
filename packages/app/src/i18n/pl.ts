export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenLoop",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenLoop.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenLoop Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenLoop.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenLoop.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w openloop.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenLoop, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie OpenLoop...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie OpenLoop w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie OpenLoop...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie OpenLoop w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj OpenLoop w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj OpenLoop",
  "wsl.onboarding.opencodeReadyIn": "OpenLoop jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenLoop jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj OpenLoop w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj OpenLoop",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoop nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim OpenLoop będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "OpenLoop nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz OpenLoop.",
  ...
  "toast.update.description": "Nowa wersja OpenLoop ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenLoop",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (openloop.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: OpenLoop nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "OpenLoop zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer OpenLoop wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenLoop",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenLoop na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenLoop ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenLoop.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenLoop",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenLoop.",
