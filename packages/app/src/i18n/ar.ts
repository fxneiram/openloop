export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من OpenLoop",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في OpenLoop.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك OpenLoop Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في OpenLoop.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في OpenLoop.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في openloop.json",
  ...
  "dialog.server.description": "تبديل خادم OpenLoop الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من OpenLoop...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من OpenLoop في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث OpenLoop...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث OpenLoop في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث OpenLoop في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث OpenLoop",
  "wsl.onboarding.opencodeReadyIn": "OpenLoop جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenLoop جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت OpenLoop في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت OpenLoop",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoop غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن OpenLoop من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على OpenLoop التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح OpenLoop.",
  ...
  "toast.update.description": "نسخة جديدة من OpenLoop ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق OpenLoop",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (openloop.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن OpenLoop لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن OpenLoop نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم OpenLoop داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ OpenLoop",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور OpenLoop على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان OpenLoop يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة OpenLoop.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل OpenLoop",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من OpenLoop.",
