export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo OpenLoop",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no OpenLoop.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenLoop Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no OpenLoop.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no OpenLoop.",
  ...
  "dialog.plugins.empty": "Plugins configurados em openloop.json",
  ...
  "dialog.server.description": "Trocar para qual servidor OpenLoop este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o OpenLoop...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o OpenLoop em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o OpenLoop...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o OpenLoop em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o OpenLoop em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o OpenLoop",
  "wsl.onboarding.opencodeReadyIn": "O OpenLoop está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O OpenLoop está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o OpenLoop em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o OpenLoop",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoop não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o OpenLoop possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O OpenLoop não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o OpenLoop novamente.",
  ...
  "toast.update.description": "Uma nova versão do OpenLoop ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do OpenLoop",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (openloop.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: OpenLoop ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenLoop inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor OpenLoop dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do OpenLoop",
  ...
  "settings.general.row.appearance.description": "Personalize como o OpenLoop aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o OpenLoop segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o OpenLoop é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o OpenLoop iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do OpenLoop.",
