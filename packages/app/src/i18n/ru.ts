export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от OpenLoop",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в OpenLoop.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenLoop Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в OpenLoop.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в OpenLoop.",
  ...
  "dialog.plugins.empty": "Плагины настроены в openloop.json",
  ...
  "dialog.server.description": "Переключите сервер OpenLoop к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка OpenLoop...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка OpenLoop в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление OpenLoop...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление OpenLoop в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите OpenLoop в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить OpenLoop",
  "wsl.onboarding.opencodeReadyIn": "OpenLoop в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "OpenLoop готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите OpenLoop в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить OpenLoop",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoop не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в OpenLoop требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "OpenLoop не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте OpenLoop.",
  ...
  "toast.update.description": "Новая версия OpenLoop ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде OpenLoop",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (openloop.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что OpenLoop пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "OpenLoop включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер OpenLoop внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения OpenLoop",
  ...
  "settings.general.row.appearance.description": "Настройте как OpenLoop выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли OpenLoop системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление OpenLoop.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске OpenLoop",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию OpenLoop.",
