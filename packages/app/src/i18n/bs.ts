export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OpenLoop",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OpenLoop-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenLoop Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OpenLoop-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OpenLoop-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u openloop.json",
  ...
  "dialog.server.description": "Promijeni na koji se OpenLoop server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera OpenLoop...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera OpenLoop u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje OpenLoop...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje OpenLoop u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj OpenLoop u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj OpenLoop",
  "wsl.onboarding.opencodeReadyIn": "OpenLoop je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenLoop je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj OpenLoop u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj OpenLoop",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoop nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi OpenLoop mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "OpenLoop nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori OpenLoop.",
  ...
  "toast.update.description": "Nova verzija OpenLoop-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OpenLoop timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (openloop.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OpenLoop još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OpenLoop uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OpenLoop server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OpenLoop-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako OpenLoop izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OpenLoop prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OpenLoop-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OpenLoop pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OpenLoop-a.",
