...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von OpenLoop",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OpenLoop zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenLoop Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in OpenLoop zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OpenLoop zu nutzen.",
  ...
  "dialog.plugins.empty": "In openloop.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den OpenLoop-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "OpenLoop",
  ...
  "wsl.onboarding.checkingOpencode": "OpenLoop wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "OpenLoop in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "OpenLoop wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "OpenLoop in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie OpenLoop in {{distro}}.",
  "wsl.onboarding.updateOpencode": "OpenLoop aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "OpenLoop ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "OpenLoop ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie OpenLoop in {{distro}}.",
  "wsl.onboarding.installOpencode": "OpenLoop installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoop nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor OpenLoop einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "OpenLoop konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann OpenLoop erneut.",
  ...
  "toast.update.description": "Eine neue Version von OpenLoop ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem OpenLoop-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (openloop.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: OpenLoop unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "OpenLoop enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "OpenLoop Desktop",
  ...
  "settings.desktop.wsl.description": "OpenLoop-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OpenLoop ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie OpenLoop auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob OpenLoop dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von OpenLoop anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OpenLoop automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von OpenLoop.",
