export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por OpenLoop",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OpenLoop.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenLoop Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OpenLoop.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OpenLoop.",
  ...
  "dialog.plugins.empty": "Plugins configurados en openloop.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de OpenLoop se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando OpenLoop...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando OpenLoop en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando OpenLoop...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando OpenLoop en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza OpenLoop en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar OpenLoop",
  "wsl.onboarding.opencodeReadyIn": "OpenLoop está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenLoop está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala OpenLoop en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar OpenLoop",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoop no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que OpenLoop pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "OpenLoop no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir OpenLoop.",
  ...
  "toast.update.description": "Una nueva versión de OpenLoop ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de OpenLoop",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (openloop.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, OpenLoop no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "OpenLoop incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor OpenLoop dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para OpenLoop",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve OpenLoop en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si OpenLoop sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de OpenLoop.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia OpenLoop",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de OpenLoop.",
