export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenLoop",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenLoop.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "OpenLoop Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenLoop.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenLoop.",
  ...
  "dialog.plugins.empty": "Plugins configured in openloop.json",
  ...
  "dialog.server.description": "Switch which OpenLoop server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking OpenLoop...",
  "wsl.onboarding.checkingOpencodeIn": "Checking OpenLoop in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating OpenLoop...",
  "wsl.onboarding.updatingOpencodeIn": "Updating OpenLoop in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update OpenLoop in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update OpenLoop",
  "wsl.onboarding.opencodeReadyIn": "OpenLoop is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenLoop is ready.",
  "wsl.onboarding.installOpencodeIn": "Install OpenLoop in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install OpenLoop",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoop not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before OpenLoop can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "OpenLoop could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen OpenLoop.",
  ...
  "toast.update.description": "A new version of OpenLoop ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenLoop team",
  ...
  "error.chain.checkConfig": "Check your config (openloop.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenLoop does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenLoop includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the OpenLoop server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OpenLoop",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how OpenLoop looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenLoop follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenLoop is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenLoop launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenLoop.",
