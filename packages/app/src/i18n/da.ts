export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OpenLoop",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i OpenLoop.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenLoop Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i OpenLoop.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i OpenLoop.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i openloop.json",
  ...
  "dialog.server.description": "Skift hvilken OpenLoop-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker OpenLoop...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker OpenLoop i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer OpenLoop...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer OpenLoop i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater OpenLoop i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater OpenLoop",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoop er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før OpenLoop kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "OpenLoop kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter OpenLoop igen.",
  ...
  "toast.update.description": "En ny version af OpenLoop ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OpenLoop-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (openloop.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OpenLoop understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OpenLoop inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør OpenLoop-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OpenLoop",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan OpenLoop ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om OpenLoop følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan OpenLoop er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OpenLoop starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OpenLoop.",
