export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "OpenLoopが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、OpenLoopで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenLoop Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してOpenLoopで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、OpenLoopで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "openloop.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するOpenLoopサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "OpenLoopを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のOpenLoopを確認中...",
  "wsl.onboarding.updatingOpencode": "OpenLoopを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のOpenLoopを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のOpenLoopを更新してください。",
  "wsl.onboarding.updateOpencode": "OpenLoopを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のOpenLoopの準備ができました。",
  "wsl.onboarding.opencodeReady": "OpenLoopの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にOpenLoopをインストールしてください。",
  "wsl.onboarding.installOpencode": "OpenLoopをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoopがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenLoopでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、OpenLoopをもう一度開いてください。",
  ...
  "toast.update.description": "OpenLoopの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをOpenLoopチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (openloop.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: OpenLoopはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "OpenLoopには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でOpenLoopサーバーを実行します。",
  ...
  "settings.general.row.language.description": "OpenLoopの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのOpenLoopの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "OpenLoopがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "OpenLoopのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "OpenLoop の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "OpenLoop は最新バージョンです。",
