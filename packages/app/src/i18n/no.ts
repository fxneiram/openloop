...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OpenLoop",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i OpenLoop.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenLoop Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OpenLoop.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OpenLoop.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i openloop.json",
  ...
  "dialog.server.description": "Bytt hvilken OpenLoop-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OpenLoop ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OpenLoop-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (openloop.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OpenLoop ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OpenLoop inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør OpenLoop-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OpenLoop",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OpenLoop ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om OpenLoop skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan OpenLoop er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OpenLoop starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OpenLoop.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker OpenLoop...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker OpenLoop i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer OpenLoop...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer OpenLoop i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater OpenLoop i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater OpenLoop",
  "wsl.onboarding.opencodeReadyIn": "OpenLoop er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenLoop er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer OpenLoop i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoop er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før OpenLoop kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "OpenLoop kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter OpenLoop på nytt.",
