...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "OpenLoop tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OpenLoop'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenLoop Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak OpenLoop'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OpenLoop'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler openloop.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OpenLoop sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "OpenLoop kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde OpenLoop kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "OpenLoop güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde OpenLoop güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki OpenLoop'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "OpenLoop'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde OpenLoop hazır.",
  "wsl.onboarding.opencodeReady": "OpenLoop hazır.",
  "wsl.onboarding.installOpencodeIn": "OpenLoop'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "OpenLoop'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoop kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenLoop'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "OpenLoop bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından OpenLoop'u tekrar açın.",
  ...
  "toast.update.description": "OpenLoop'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OpenLoop ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (openloop.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: OpenLoop henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "OpenLoop ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "OpenLoop Masaüstü",
  ...
  "settings.desktop.wsl.description": "OpenLoop sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "OpenLoop'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "OpenLoop'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OpenLoop'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OpenLoop'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OpenLoop başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OpenLoop'un en son sürümünü kullanıyorsunuz.",
