export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par OpenLoop",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OpenLoop.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenLoop Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OpenLoop.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OpenLoop.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans openloop.json",
  ...
  "dialog.server.description": "Changez le serveur OpenLoop auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'OpenLoop...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'OpenLoop dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'OpenLoop...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'OpenLoop dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour OpenLoop dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour OpenLoop",
  "wsl.onboarding.opencodeReadyIn": "OpenLoop est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenLoop est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez OpenLoop dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer OpenLoop",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenLoop non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'OpenLoop puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "OpenLoop n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez OpenLoop.",
  ...
  "toast.update.description":
    "Une nouvelle version d'OpenLoop ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe OpenLoop",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (openloop.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'OpenLoop ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "OpenLoop inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur OpenLoop dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour OpenLoop",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'OpenLoop sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si OpenLoop suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'OpenLoop.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'OpenLoop",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'OpenLoop.",
