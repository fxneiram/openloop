...
declare const OPENLOOP_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof OPENLOOP_CLI_NAME === "string" ? OPENLOOP_CLI_NAME : "openloop", {
  description: "OpenLoop 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
