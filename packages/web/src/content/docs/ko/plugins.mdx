...
- `.openloop/plugins/` - 프로젝트 레벨 플러그인
- `~/.config/openloop/plugins/` - 글로벌 플러그인
...
1. 글로벌 구성 (`~/.config/openloop/openloop.json`)
2. 프로젝트 구성 (`openloop.json`)
3. 글로벌 플러그인 디렉토리 (`~/.config/openloop/plugins/`)
4. 프로젝트 플러그인 디렉토리 (`.openloop/plugins/`)
