...
2. **Konfigurer autentisering** ved å bruke en av følgende metoder:
   ...
   For prosjektspesifikk eller vedvarende konfigurasjon, bruk `openloop.json`:
...
`openloop.json` fil. Det anbefales også å deaktivere øktdeling.
...
4. Opprett eller oppdater `openloop.json`-filen i prosjektkatalogen:
