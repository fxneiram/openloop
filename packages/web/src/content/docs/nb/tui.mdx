...
Dette er atskilt fra `openloop.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `OPENLOOP_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
