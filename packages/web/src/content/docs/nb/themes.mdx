...
2. **Brukerkonfigurasjonskatalog** - Definert i `~/.config/openloop/themes/*.json` eller `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Prosjektrotkatalog** - Definert i `<project-root>/.openloop/themes/*.json`
4. **Gjeldende arbeidskatalog** - Definert i `./.openloop/themes/*.json`
