...
- `.openloop/plugins/` - Programtillegg på prosjektnivå
...
1. Global konfigurasjon (`~/.config/openloop/openloop.json`)
2. Prosjektkonfigurasjon (`openloop.json`)
3. Global plugin-katalog (`~/.config/openloop/plugins/`)
4. Prosjektpluginkatalog (`.openloop/plugins/`)
