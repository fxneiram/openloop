...
- `.openloop/plugins/` - Project-level plugins
- `~/.config/openloop/plugins/` - Global plugins
...
3. Global plugin directory (`~/.config/openloop/plugins/`)
4. Project plugin directory (`.openloop/plugins/`)
