...
- การกำหนดค่าโครงการ: `.openloop/skills/<name>/SKILL.md`
- การกำหนดค่าส่วนกลาง: `~/.config/openloop/skills/<name>/SKILL.md`
...
โดยจะโหลด `skills/*/SKILL.md` ที่ตรงกันใน `.openloop/` และ `.claude/skills/*/SKILL.md` หรือ `.agents/skills/*/SKILL.md` ที่ตรงกันตลอดทาง

คำจำกัดความสากลยังโหลดจาก `~/.config/openloop/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` และ `~/.agents/skills/*/SKILL.md`
...
สร้าง `.openloop/skills/git-release/SKILL.md` แบบนี้:
...
ควบคุมว่าตัวแทนทักษะใดสามารถเข้าถึงโดยใช้สิทธิ์ตามรูปแบบใน `openloop.json`:
...
**สำหรับตัวแทนในตัว** (ใน `openloop.json`):
