...
- `.openloop/plugins/` - ​​ปลั๊กอินระดับโครงการ
- `~/.config/openloop/plugins/` - ​​ปลั๊กอินทั่วโลก
...
1. การกำหนดค่าส่วนกลาง (`~/.config/openloop/openloop.json`)
2. การกำหนดค่าโครงการ (`openloop.json`)
3. ไดเร็กทอรีปลั๊กอินสากล (`~/.config/openloop/plugins/`)
4. ไดเรกทอรีปลั๊กอินโครงการ (`.openloop/plugins/`)
