...
- `.openloop/plugins/` - Dodaci na nivou projekta
- `~/.config/openloop/plugins/` - Globalni dodaci
...
1. Globalna konfiguracija (`~/.config/openloop/openloop.json`)
2. Konfiguracija projekta (`openloop.json`)
3. Globalni direktorij dodataka (`~/.config/openloop/plugins/`)
4. Direktorij dodataka projekta (`.openloop/plugins/`)
