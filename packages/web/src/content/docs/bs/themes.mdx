...
2. **Korisnicki config direktorij** - `~/.config/openloop/themes/*.json` ili `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Korijenski direktorij projekta** - `<project-root>/.openloop/themes/*.json`
4. **Trenutni radni direktorij** - `./.openloop/themes/*.json`
