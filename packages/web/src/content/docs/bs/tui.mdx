...
Ovo je odvojeno od `openloop.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `OPENLOOP_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
