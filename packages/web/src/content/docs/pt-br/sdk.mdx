...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `openloop.json`, mas você pode substituir ou adicionar configuração inline:
