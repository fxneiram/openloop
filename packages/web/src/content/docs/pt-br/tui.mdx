...
Isso é separado do `openloop.json`, que configura o comportamento do servidor/runtime.
...
Use `OPENLOOP_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
