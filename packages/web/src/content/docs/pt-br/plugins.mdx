...
- `.openloop/plugins/` - Plugins em nível de projeto
- `~/.config/openloop/plugins/` - Plugins globais
...
1. Configuração global (`~/.config/openloop/openloop.json`)
2. Configuração do projeto (`openloop.json`)
3. Diretório de plugins global (`~/.config/openloop/plugins/`)
4. Diretório de plugins do projeto (`.openloop/plugins/`)
