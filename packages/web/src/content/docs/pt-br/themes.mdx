...
2. **Diretório de configuração do usuário** - Definido em `~/.config/openloop/themes/*.json` ou `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Diretório raiz do projeto** - Definido em `<project-root>/.openloop/themes/*.json`
4. **Diretório de trabalho atual** - Definido em `./.openloop/themes/*.json`
