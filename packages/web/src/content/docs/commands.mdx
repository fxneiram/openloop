...
Create `.openloop/commands/test.md`:

```md title=".openloop/commands/test.md"
---
...
```json title="openloop.jsonc" {4-12}
{
...
- Global: `~/.config/openloop/commands/`
- Per-project: `.openloop/commands/`

```markdown title="~/.config/openloop/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".openloop/commands/component.md"
---
...
```md title=".openloop/commands/create-file.md"
---
...
```md title=".openloop/commands/analyze-coverage.md"
---
...
```md title=".openloop/commands/review-changes.md"
---
...
```md title=".openloop/commands/review-component.md"
---
...
openloop includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
