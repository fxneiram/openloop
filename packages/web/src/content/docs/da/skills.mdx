...
- Prosjektkonfigurasjon: `.openloop/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/openloop/skills/<name>/SKILL.md`
...
Den laster alle matchende `skills/*/SKILL.md` i `.openloop/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/openloop/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.openloop/skills/git-release/SKILL.md` slik:
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `openloop.json`:
...
**For innebygde agenter** (i `openloop.json`):
