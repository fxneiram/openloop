...
- `.openloop/plugins/` - Plugins på projektniveau
...
1. Global konfiguration (`~/.config/openloop/openloop.json`)
2. Projektkonfiguration (`openloop.json`)
3. Global plugin-mappe (`~/.config/openloop/plugins/`)
4. Projekt plugin bibliotek (`.openloop/plugins/`)
