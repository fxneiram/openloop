...
Dette er adskilt fra `openloop.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `OPENLOOP_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
