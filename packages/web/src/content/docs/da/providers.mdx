...
2. **Konfigurer godkendelse** ved at bruge en af følgende metoder:
   ...
   For projektspecifik eller vedvarende konfiguration, brug `openloop.json`:
...
`openloop.json` fil. Det anbefales også at deaktivere sessionsdeling.
...
4. Opret eller opdater `openloop.json`-filen i projektkataloget:
