...
- `.openloop/plugins/` – плагины уровня проекта.
- `~/.config/openloop/plugins/` — глобальные плагины
...
1. Глобальная конфигурация (`~/.config/openloop/openloop.json`)
2. Конфигурация проекта (`openloop.json`)
3. Глобальный каталог плагинов (`~/.config/openloop/plugins/`)
4. Каталог плагинов проекта (`.openloop/plugins/`)
