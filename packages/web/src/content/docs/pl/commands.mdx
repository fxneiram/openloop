...
Utwórz `.openloop/commands/test.md`:
...
Możesz zdefiniować polecenia w `openloop.json` lub w plikach w katalogu `commands/`.
...
- Globalnie: `~/.config/openloop/commands/`
- Na projekt: `.openloop/commands/`
