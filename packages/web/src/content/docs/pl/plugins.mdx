...
- `.openloop/plugins/` - Wtyczki na poziomie projektu
- `~/.config/openloop/plugins/` - Wtyczki globalne
...
1. Konfiguracja globalna (`~/.config/openloop/openloop.json`)
2. Konfiguracja projektu (`openloop.json`)
3. Globalny katalog wtyczek (`~/.config/openloop/plugins/`)
4. Katalog wtyczek projektu (`.openloop/plugins/`)
