...
- Project config: `.openloop/skills/<name>/SKILL.md`
- Global config: `~/.config/openloop/skills/<name>/SKILL.md`
...
Ładuje po drodze dowolne pasujące `skills/*/SKILL.md` w `.openloop/` i dowolne pasujące `.claude/skills/*/SKILL.md` lub `.agents/skills/*/SKILL.md`.

Ładowane są także definicje globalne z `~/.config/openloop/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Utwórz `.openloop/skills/git-release/SKILL.md` w ten sposób:
...
Kontroluj, do których umiejętności agenci mogą uzyskać dostęp, używając uprawnień opartych na wzorcach w `openloop.json`:
...
**Dla agentów wbudowanych** (w `openloop.json`):
