...
Jest to oddzielny plik od `openloop.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `OPENLOOP_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
