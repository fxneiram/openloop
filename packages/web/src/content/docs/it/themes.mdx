...
2. **Directory di configurazione utente** - in `~/.config/openloop/themes/*.json` o `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Directory root del progetto** - in `<project-root>/.openloop/themes/*.json`
4. **Directory di lavoro corrente** - in `./.openloop/themes/*.json`
