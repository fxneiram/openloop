...
Questo è separato da `openloop.json`, che configura il comportamento di server/runtime.
...
Usa `OPENLOOP_TUI_CONFIG` per caricare un path di configurazione TUI personalizzato.
