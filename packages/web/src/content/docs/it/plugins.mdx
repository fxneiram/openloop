...
- `.openloop/plugins/` - plugin a livello progetto
- `~/.config/openloop/plugins/` - plugin globali
...
1. Config globale (`~/.config/openloop/openloop.json`)
2. Config di progetto (`openloop.json`)
3. Directory plugin globale (`~/.config/openloop/plugins/`)
4. Directory plugin di progetto (`.openloop/plugins/`)
