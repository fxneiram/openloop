...
2. **Configura l'autenticazione** usando uno dei seguenti metodi:
   ...
   ***
   ...
   Per configurazione specifica del progetto o persistente, usa `openloop.json`:
...
file `openloop.json`. Si raccomanda anche di disabilitare la condivisione sessioni.
...
Personalizza tramite `openloop.json`:
...
4. Crea o aggiorna il tuo file `openloop.json` nella directory del progetto:
