...
- `.openloop/plugins/` - プロジェクトレベルのプラグイン
- `~/.config/openloop/plugins/` - グローバルプラグイン
...
1. グローバル設定 (`~/.config/openloop/openloop.json`)
2. プロジェクト設定 (`openloop.json`)
3. グローバルプラグインディレクトリ (`~/.config/openloop/plugins/`)
4. プロジェクトプラグインディレクトリ (`.openloop/plugins/`)
