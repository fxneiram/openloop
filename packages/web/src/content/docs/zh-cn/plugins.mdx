...
- `.openloop/plugins/` - 项目级插件
- `~/.config/openloop/plugins/` - 全局插件
...
1. 全局配置 (`~/.config/openloop/openloop.json`)
2. 项目配置 (`openloop.json`)
3. 全局插件目录 (`~/.config/openloop/plugins/`)
4. 项目插件目录 (`.openloop/plugins/`)
