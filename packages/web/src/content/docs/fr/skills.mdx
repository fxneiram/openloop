...
- Configuration du projet : `.openloop/skills/<name>/SKILL.md`
- Configuration globale : `~/.config/openloop/skills/<name>/SKILL.md`
...
Il charge tout `skills/*/SKILL.md` correspondant dans `.openloop/` et tout `.claude/skills/*/SKILL.md` ou `.agents/skills/*/SKILL.md` correspondant en cours de route.

Les définitions globales sont également chargées à partir de `~/.config/openloop/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` et `~/.agents/skills/*/SKILL.md`.
...
Créez `.openloop/skills/git-release/SKILL.md` comme ceci :
...
Contrôlez les compétences auxquelles les agents peuvent accéder à l'aide d'autorisations basées sur des modèles dans `openloop.json` :
...
**Pour les agents intégrés** (dans `openloop.json`) :
