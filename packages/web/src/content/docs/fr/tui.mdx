...
Ceci est séparé de `openloop.json`, qui configure le comportement du serveur/d'exécution.
...
Utilisez `OPENLOOP_TUI_CONFIG` pour charger un chemin de configuration TUI personnalisé.
