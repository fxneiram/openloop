...
- `.openloop/plugins/` - Plugins au niveau du projet
- `~/.config/openloop/plugins/` - Plugins globaux
...
1. Configuration globale (`~/.config/openloop/openloop.json`)
2. Configuration du projet (`openloop.json`)
3. Répertoire global des plugins (`~/.config/openloop/plugins/`)
4. Répertoire des plugins du projet (`.openloop/plugins/`)
