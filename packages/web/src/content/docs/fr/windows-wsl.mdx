...
:::caution
Lorsque vous utilisez `--hostname 0.0.0.0`, définissez `OPENLOOP_SERVER_PASSWORD` pour sécuriser le serveur.

```bash
OPENLOOP_SERVER_PASSWORD=your-password opencode serve --hostname 0.0.0.0
```
