...
Configurez les agents dans votre fichier de configuration `openloop.json` :
...
- Global : `~/.config/openloop/agents/`
- Par projet : `.openloop/agents/`

```markdown title="~/.config/openloop/agents/review.md"
---
...
```json title="openloop.json" {3-6,9-12}
{
  "$schema": "https://opencode.ai/config.json",
  "tools": {
    "write": true,
...
```json title="openloop.json" {3-5,8-10}
{
  "$schema": "https://opencode.ai/config.json",
  "permission": {
    "edit": "deny"
...
```markdown title="~/.config/openloop/agents/docs-writer.md"
---
...
```markdown title="~/.config/openloop/agents/security-auditor.md"
---
