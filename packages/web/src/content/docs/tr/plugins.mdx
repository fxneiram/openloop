...
- `.openloop/plugins/` - Proje düzeyinde eklentiler
- `~/.config/openloop/plugins/` - Genel eklentiler
...
1. Global config (`~/.config/openloop/openloop.json`)
2. Project config (`openloop.json`)
3. Global eklenti dizini (`~/.config/openloop/plugins/`)
4. Proje eklenti dizini (`.openloop/plugins/`)
