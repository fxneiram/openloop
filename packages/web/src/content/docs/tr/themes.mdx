...
2. **Kullanıcı yapılandırma dizini** - `~/.config/openloop/themes/*.json` veya `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Proje kök dizini** - `<project-root>/.openloop/themes/*.json`
4. **Geçerli çalışma dizini** - `./.openloop/themes/*.json`
