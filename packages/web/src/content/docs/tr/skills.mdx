...
- Proje konfigurasyonu: `.openloop/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/openloop/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.openloop/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/openloop/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.openloop/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
`openloop.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`openloop.json` icinde):
