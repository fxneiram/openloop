...
2. **Directorio de configuración de usuario**: definido en `~/.config/openloop/themes/*.json` o `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.openloop/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.openloop/themes/*.json`
