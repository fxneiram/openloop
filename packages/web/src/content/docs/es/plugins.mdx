...
- `.openloop/plugins/` - Complementos a nivel de proyecto
- `~/.config/openloop/plugins/` - Complementos globales
...
1. Configuración global (`~/.config/openloop/openloop.json`)
2. Configuración del proyecto (`openloop.json`)
3. Directorio global de complementos (`~/.config/openloop/plugins/`)
4. Directorio de complementos del proyecto (`.openloop/plugins/`)
...
```json title=".openloop/package.json"
{
  "dependencies": {
    "shescape": "^2.1.0"
  }
...
```ts title=".openloop/plugins/my-plugin.ts"
...
```js title=".openloop/plugins/example.js"
...
```js title=".openloop/plugins/notification.js"
...
```javascript title=".openloop/plugins/env-protection.js"
...
```javascript title=".openloop/plugins/inject-env.js"
...
```ts title=".openloop/plugins/custom-tools.ts"
...
```ts title=".openloop/plugins/compaction.ts"
import type { Plugin } from "@opencode-ai/plugin"
...
```ts title=".openloop/plugins/custom-compaction.ts"
import type { Plugin } from "@opencode-ai/plugin"
