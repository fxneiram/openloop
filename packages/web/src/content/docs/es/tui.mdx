...
Esto es independiente de `openloop.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `OPENLOOP_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
