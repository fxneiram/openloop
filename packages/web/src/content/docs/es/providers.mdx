...
2. **Configure la autenticación** utilizando uno de los siguientes métodos:
   ...
   Para una configuración persistente o específica del proyecto, utilice `openloop.json`:
...
Archivo `openloop.json`. También se recomienda desactivar el uso compartido de sesiones.
...
Personalizar a través de `openloop.json`:
...
4. Cree o actualice su archivo `openloop.json` en el directorio de su proyecto:
