...
It loads any matching `skills/*/SKILL.md` in `.openloop/` and any matching `.claude/skills/*/SKILL.md` or `.agents/skills/*/SKILL.md` along the way.

Global definitions are also loaded from `~/.config/openloop/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md`, and `~/.agents/skills/*/SKILL.md`.
...
Create `.openloop/skills/git-release/SKILL.md` like this:
...
Control which skills agents can access using pattern-based permissions in `openloop.json`:
...
**For built-in agents** (in `openloop.json`):
