...
- `.openloop/plugins/` - 專案級外掛
- `~/.config/openloop/plugins/` - 全域外掛
...
1. 全域設定 (`~/.config/openloop/openloop.json`)
2. 專案設定 (`openloop.json`)
3. 全域外掛目錄 (`~/.config/openloop/plugins/`)
4. 專案外掛目錄 (`.openloop/plugins/`)
