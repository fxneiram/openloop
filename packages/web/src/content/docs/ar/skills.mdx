...
- إعدادات المشروع: `.openloop/skills/<name>/SKILL.md`
- إعدادات عامة: `~/.config/openloop/skills/<name>/SKILL.md`
...
ويحمّل أي ملفات مطابقة لـ `skills/*/SKILL.md` داخل `.openloop/` وأي ملفات مطابقة لـ `.claude/skills/*/SKILL.md` أو `.agents/skills/*/SKILL.md` على طول الطريق.

كما تُحمَّل التعريفات العامة أيضاً من `~/.config/openloop/skills/*/SKILL.md` و `~/.claude/skills/*/SKILL.md` و `~/.agents/skills/*/SKILL.md`.
...
أنشئ `.openloop/skills/git-release/SKILL.md` بهذا الشكل:
...
تحكم في المهارات التي يمكن للوكلاء الوصول إليها باستخدام صلاحيات مبنية على أنماط داخل `openloop.json`:
...
**للوكلاء المدمجين** (في `openloop.json`):
