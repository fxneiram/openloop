...
2. **اضبط المصادقة** باستخدام إحدى الطرق التالية:
   ...
   للإعداد الخاص بالمشروع أو الإعداد الدائم، استخدم `openloop.json`:
...
`openloop.json` لديك. يوصى أيضا بتعطيل مشاركة الجلسات.
...
4. أنشئ أو حدّث ملف `openloop.json` في دليل مشروعك:
