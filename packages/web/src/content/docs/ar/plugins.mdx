...
- `.openloop/plugins/` - إضافات على مستوى المشروع
- `~/.config/openloop/plugins/` - إضافات عامة
...
1. إعدادات عامة (`~/.config/openloop/openloop.json`)
2. إعدادات المشروع (`openloop.json`)
3. دليل الإضافات العام (`~/.config/openloop/plugins/`)
4. دليل إضافات المشروع (`.openloop/plugins/`)
