...
Dies ist getrennt von `openloop.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `OPENLOOP_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
