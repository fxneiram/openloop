...
- `.openloop/plugins/` – Plugins auf Projektebene
- `~/.config/openloop/plugins/` – Globale Plugins
...
1. Globale Konfiguration (`~/.config/openloop/openloop.json`)
2. Projektkonfiguration (`openloop.json`)
3. Globales Plugin-Verzeichnis (`~/.config/openloop/plugins/`)
4. Projekt-Plugin-Verzeichnis (`.openloop/plugins/`)
