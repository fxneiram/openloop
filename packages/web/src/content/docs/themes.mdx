...
2. **User config directory** - Defined in `~/.config/openloop/themes/*.json` or `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Project root directory** - Defined in the `<project-root>/.openloop/themes/*.json`
4. **Current working directory** - Defined in `./.openloop/themes/*.json`
