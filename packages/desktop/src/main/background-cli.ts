...
const desktopStateNames = ["ai.openloop.desktop.dev", "ai.openloop.desktop.beta", "ai.openloop.desktop"]
...
function executableName() {
  return process.platform === "win32" ? "openloop-cli.exe" : "openloop-cli"
}
