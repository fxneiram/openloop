export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de OpenLoop",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de OpenLoop. ¿Quieres instalarla y reiniciar?",
