export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OpenLoop-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OpenLoop-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
