export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OpenLoop",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OpenLoop a été téléchargée. Voulez-vous l'installer et redémarrer ?",
