export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenLoop",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenLoop er lastet ned. Vil du installere den og starte på nytt?",
