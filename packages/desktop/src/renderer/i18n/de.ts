export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OpenLoop",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OpenLoop wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
