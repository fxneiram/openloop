export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OpenLoop",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OpenLoop er blevet downloadet. Vil du installere den og genstarte?",
