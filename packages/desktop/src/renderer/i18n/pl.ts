export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OpenLoop",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OpenLoop. Czy chcesz ją zainstalować i uruchomić ponownie?",
