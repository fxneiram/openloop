...
const releaseId = process.env.OPENLOOP_RELEASE
if (!releaseId) throw new Error("OPENLOOP_RELEASE is required")

const version = process.env.OPENLOOP_VERSION
if (!version) throw new Error("OPENLOOP_VERSION is required")
...
const macxTarGz = "openloop-desktop-mac-x64.app.tar.gz"
const macaTarGz = "openloop-desktop-mac-arm64.app.tar.gz"
