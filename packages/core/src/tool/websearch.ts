...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.OPENLOOP_WEBSEARCH_PROVIDER === "exa" || process.env.OPENLOOP_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.OPENLOOP_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("OPENLOOP_EXPERIMENTAL") || truthy("OPENLOOP_ENABLE_EXA") || truthy("OPENLOOP_EXPERIMENTAL_EXA"),
    enableParallel: truthy("OPENLOOP_ENABLE_PARALLEL") || truthy("OPENLOOP_EXPERIMENTAL_PARALLEL"),
