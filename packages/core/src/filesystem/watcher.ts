...
declare const OPENLOOP_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OPENLOOP_LIBC === "undefined" ? undefined : OPENLOOP_LIBC
...
const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OPENLOOP_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.OPENLOOP_EXPERIMENTAL_FILEWATCHER)) {
