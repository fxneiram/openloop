...
//   - OPENLOOP_CONFIG_CONTENT      : provider config inline, no files to find
//   - OPENLOOP_TEST_HOME           : pins os.homedir() → tmpdir
//   - OPENLOOP_DISABLE_PROJECT_CONFIG : skip walking up for openloop.json
//   - OPENLOOP_PURE                : skip external plugin discovery + install
//   - OPENLOOP_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
...
function isolatedEnv(home: string, configJson: string): Record<string, string> {
  return {
    ...
    OPENLOOP_PURE: "1",
    OPENLOOP_DISABLE_AUTOUPDATE: "1",
    OPENLOOP_DISABLE_AUTOCOMPACT: "1",
    OPENLOOP_DISABLE_MODELS_FETCH: "1",
    OPENLOOP_AUTH_CONTENT: "{}",
  }
}
  ...
  return Effect.gen(function* () {
    ...
    const runOpts = (opts?: RunOpts): SpawnOpts | undefined => {
      ...
      return {
        ...
        env: {
          ...opts.env,
          OPENLOOP_CONFIG_CONTENT: JSON.stringify({
