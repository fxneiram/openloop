...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENLOOP_CALLER", () => {
    process.env["OPENLOOP_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENLOOP_CALLER", () => {
    process.env["OPENLOOP_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENLOOP_CALLER", () => {
    process.env["OPENLOOP_CALLER"] = "unknown"
