...
function globalConfigFile() {
  const candidates = ["openloop.jsonc", "openloop.json", "opencode.jsonc", "opencode.json", "config.json"].map((file) =>
      ...
      function* (ctx: InstanceContext) {
        ...
        for (const dir of directories) {
          if (dir.endsWith(".opencode") || dir === Flag.OPENCODE_CONFIG_DIR) {
            for (const file of ["openloop.json", "openloop.jsonc", "opencode.json", "opencode.jsonc"]) {
