...
nix run nixpkgs#opencode           # ou github:fxneiram/openloop pour la branche dev la plus récente
```
...
OpenCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/fxneiram/openloop/releases) ou [opencode.ai/download](https://opencode.ai/download).
