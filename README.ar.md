...
nix run nixpkgs#opencode           # او github:fxneiram/openloop لاحدث فرع dev
```
...
يتوفر OpenCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/fxneiram/openloop/releases) او من [opencode.ai/download](https://opencode.ai/download).
