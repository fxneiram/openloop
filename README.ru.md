...
nix run nixpkgs#opencode           # или github:fxneiram/openloop для самой свежей ветки dev
```
...
OpenCode также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/fxneiram/openloop/releases) или с [opencode.ai/download](https://opencode.ai/download).
