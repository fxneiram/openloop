...
nix run nixpkgs#opencode           # veya en güncel geliştirme dalı için github:fxneiram/openloop
```
...
OpenCode ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/fxneiram/openloop/releases) veya [opencode.ai/download](https://opencode.ai/download) adresinden indirebilirsiniz.
