...
nix run nixpkgs#opencode           # hoặc github:fxneiram/openloop cho nhánh dev mới nhất
```
...
OpenCode cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/fxneiram/openloop/releases) hoặc [opencode.ai/download](https://opencode.ai/download).
