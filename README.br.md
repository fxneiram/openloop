...
nix run nixpkgs#opencode           # ou github:fxneiram/openloop para a branch dev mais recente
```
...
O OpenCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/fxneiram/openloop/releases) ou em [opencode.ai/download](https://opencode.ai/download).
