...
<p align="center">
  ...
  <a href="https://github.com/fxneiram/openloop/actions/workflows/publish.yml"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/fxneiram/openloop/publish.yml?style=flat-square&branch=dev" /></a>
</p>
...
nix run nixpkgs#opencode           # oppure github:fxneiram/openloop per l’ultima branch di sviluppo
```
...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/fxneiram/openloop/releases) oppure da [opencode.ai/download](https://opencode.ai/download).
