...
describe("translate app", () => {
  ...
  test("maps product locale codes to their glossaries", () => {
    expect(glossaryFile("fr")).toBe(".openloop/glossary/fr.md")
    expect(glossaryFile("zh")).toBe(".openloop/glossary/zh-cn.md")
    expect(glossaryFile("zht")).toBe(".openloop/glossary/zh-tw.md")
  })
