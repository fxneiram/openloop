...
- Canonicalize ambient instruction traversal boundaries, honor `OPENLOOP_DISABLE_PROJECT_CONFIG`, and make non-empty aggregate updates explicitly supersede previously loaded instructions.
