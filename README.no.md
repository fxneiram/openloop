...
nix run nixpkgs#opencode           # eller github:fxneiram/openloop for nyeste dev-branch
```
...
OpenCode er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/fxneiram/openloop/releases) eller [opencode.ai/download](https://opencode.ai/download).
