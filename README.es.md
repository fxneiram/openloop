...
nix run nixpkgs#opencode           # o github:fxneiram/openloop para la rama dev más reciente
```
...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/fxneiram/openloop/releases) o desde [opencode.ai/download](https://opencode.ai/download).
