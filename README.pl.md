...
nix run nixpkgs#opencode           # lub github:fxneiram/openloop dla najnowszej gałęzi dev
```
...
OpenCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/fxneiram/openloop/releases) lub z [opencode.ai/download](https://opencode.ai/download).
